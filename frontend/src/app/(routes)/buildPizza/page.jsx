            ...
            <tbody>
              {ingredients.map(ing =>
                <tr className="flex items-center h-[50px] ingredients-tr" key={ing.id}>
                  <td className="border w-[130px] h-full flex justify-start items-center px-2">
                    <Image src={ing.image} width={50} height={50} alt="" style={{ height: "50px", width: "50px" }} unoptimized />
                  </td>
              ...
              <tr className="p-2">
                <td><b className="text-sky-800">Total Cost: {ingredientsTotalPrice}</b></td>
              </tr>
              <tr className="flex justify-center items-center py-2">
                <td>
                <button className="btn build-btn">Build Pizza</button>
                </td>
              </tr>
            </tbody>
          </table>

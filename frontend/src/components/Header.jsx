...
const Header = () => {
  ...
  return (
    <div className="flex items-center md:flex-row w-screen bg-black p-2 sticky inset-0">
      ...
      <div className="flex md:hidden translate-x-full absolute inset-0 bg-black h-screen w-screen flex-col justify-center items-center gap-10 z-100" id="hamburger">
